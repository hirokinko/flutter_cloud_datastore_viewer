/// Note: Use this file until following issue is resolve!!
/// https://github.com/dart-lang/googleapis/issues/211
...
import 'package:googleapis/src/user_agent.dart' show requestHeaders;
...
class Value {
  ...
  Value.fromJson(core.Map _json) {
    ...
    if (_json.containsKey('nullValue')) {
      nullValue = _json['nullValue'] as core.Null; // patched
    }
